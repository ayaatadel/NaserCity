...
// echo $fileData["dirname"],"<br>";  // return the directory name of the path untill the directory
// echo $fileData["filename"],"<br>";  // return file name without extension   

// print_r( pathinfo(__FILE__) );  // return an array contains info about the path
// //Array ( [dirname] => D:\ITI\Ayaat_ITI\AyaatCoursesITI\3M\Php_Content\php_NaserCity\Day5\file [basename] => index.php [extension] => php [filename] => index ) array(0) { }
...
// var_dump(is_dir("newFolder22")); // create folder if not exists

// if (is_dir("newFolder22")&& is_dir("newFolder22/images")) {
...
// if(is_dir("newFolder22/images")){
// rmdir("newFolder22/images");
// }
//    else{
...
// // file_put_contents(("newFolder22/students.txt"), "");
// file_put_contents(("newFolder22/students.txt"), "Hello Pen Test \n");
// file_put_contents(("newFolder22/students.txt"), " Course PHP  \n");  // write ===> override on exist content
// file_put_contents(("newFolder22/students.txt"), " Hello php summer Training  \n", FILE_APPEND);  // append ===> add to exist content
// file_put_contents(("newFolder22/students.txt"), " new Data  \n", FILE_APPEND | LOCK_EX);  // append ===> add to exist content + lock execute ==> to prevent other users from writing to the file at the same time


// read data from file
// echo file_get_contents("newFolder22/students.txt"); // get all data in string format



// check if file exists (file_exists("filePath"))  
//  check on permissions of file
// if(file_exists("newFolder22/students.txt")){
//     if(is_writable("newFolder22/students.txt")){
//     file_put_contents(("newFolder22/students.txt"), " Hello php summer Training  \n", FILE_APPEND);  
//      echo "File Content : ",file_get_contents("newFolder22/students.txt");
...
// echo "<br> File Size : ",filesize("newFolder22/students.txt")," bytes <br>";
...
//========================= read file content
// if(file_exists("newFolder22/students.txt")){
//     $myFile=fopen("newFolder22/students.txt","r") ;
//     $myFileSize=filesize("newFolder22/students.txt");
...
// if(file_exists("newFolder22/students.txt")){
//     unlink("newFolder22/students.txt");
...
// @unlink(("newFolder22/students.txt")) or die("file not exists");  // if file not exists show message and stop execution
// if(file_exists("newFolder22/students.txt")){
//     unlink("newFolder22/students.txt");
//     echo "file deleted successfully <br>";
// }
