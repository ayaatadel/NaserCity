...
<body>
    ...
    require "bootstrap.php";
       ...
       $user = $database->show("users", $userId);
    ?>
    <h1 class="text-center text-secondary">Edit User</h1>
    <?php
    ...
    <form action="manageUser.php" method="post" class="p-3 border border-1 w-75 mx-auto">
        ...
        <button type="submit" name='btn-edit' class="btn btn-primary p-2 border-0 rounded-1 my-5">Edit User</button>
    </form>
